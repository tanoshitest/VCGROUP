...
export const translations = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        detail: {
          ...
          jp: "当社の技術者は、様々なメーカーのエアコンに対応する豊かな経験を持っています。安全で確実な技術、そして美観にも配慮した施工により、快適な空間づくりをサポートいたします。",
    ...
    catalog: {
      ...
      products: [
        { id: 1, category: "appliances", price: "￥5,000", title: { vi: "Tủ lạnh mini Panasonic", jp: "パナソニック製ミニ冷蔵庫", en: "Panasonic Mini Fridge" }, image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=400&fit=crop" },
        ...
        { id: 3, category: "appliances", price: "￥8,000", title: { vi: "Máy giặt Toshiba 6kg", jp: "東芝製洗濯機 6kg", en: "Toshiba Washing Machine 6kg" }, image: "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?q=80&w=400&fit=crop" },
